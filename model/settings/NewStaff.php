...
<div class="card w-25 h-25">
  ...
  <form action="addNewStaff.php" method="POST">
    <div class="form-group p-3">
        <h5 class=" text-center">New Staff</h5><br>
    ...
    <div class="form-group d-block">
      <input type="submit" name ="staff_submit" class="btn btn-success col-12"></input>
    </div>
</form>
  </div>
</div>
...
<div class="card w-50 h-50">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered text-center" id="NewStaff">
            <thead>
              <tr>
                <th scope="col">ID</th>
            ...
            <tbody>
            <?php require_once 'staffData.php'?>
            </tbody>
          </table>
        </div>
      </div>
